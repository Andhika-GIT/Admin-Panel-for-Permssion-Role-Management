                                        ...
                                        <div class="direct-chat-messages">
                                            ...
                                            <div class="direct-chat-msg">
                                                ...
                                                <img
                                                    ...
                                                    :src="'/storage/images/user1-128x128.jpg'"
                                            ...
                                            <div class="direct-chat-msg right">
                                                ...
                                                <img
                                                    class="direct-chat-img"
                                                    :src="'/storage/images/user3-128x128.jpg'"
                                                    alt="message user image"
                                                />
                                                <!-- /.direct-chat-img -->
                                                <div class="direct-chat-text">
                                            ...
                                            <ul class="contacts-list">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            :src="'/storage/images/user7-128x128.jpg'"
                                                            alt="User Avatar"
                                                        />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            :src="'/storage/images/user5-128x128.jpg'"
                                                            alt="User Avatar"
                                                        />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            :src="'/storage/images/user6-128x128.jpg'"
                                                            alt="User Avatar"
                                                        />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img
                                                            class="contacts-list-img"
                                                            :src="'/storage/images/user8-128x128.jpg'"
                                                            alt="User Avatar"
                                                        />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="users-list clearfix">
                                            ...
                                            <li>
                                                <img
                                                    :src="'/storage/images/user2-160x160.jpg'"
                                                    alt="User Image"
                                                />
                                                <a
                                                    class="users-list-name"
                                            ...
                                            <li>
                                                <img
                                                    :src="'/storage/images/user4-128x128.jpg'"
                                                    alt="User Image"
                                                />
                                                <a
                                                    class="users-list-name"
                                ...
                                >
                                    <li class="item">
                                        <div class="product-img">
                                            <img
                                                :src="'/storage/images/default-150x150.png'"
                                                alt="Product Image"
                                                class="img-size-50"
                                            />
                                        </div>
